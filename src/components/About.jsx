...
export default function About() {
  ...
  const aboutInnerve = useRef(null)
  ...
  useEffect(() => {
    ...
    // gsap.fromTo(
    //   aboutInnerve.current,
    //   { opacity: 0, y: 100 },
    //   {
    //     opacity: 1,
    //     y: 0,
    //     scrollTrigger: {
    //       trigger: aboutInnerve.current,
    //       start: "top 70%",
    //       scrub: true,
    //       ease: "expo.eae-InOut",
    //     },
  ...
  return (
    <div className="h-fit relative pt-4 px-2 xl:px-20  ">
      <div className="about flex flex-wrap text-white tracking-wide xl:tracking-[.5rem]  text-[2.7rem] sm:text-[4.3rem] md:text-[6rem] lg:text-[5.5rem] xl:text-[6.7rem]  leading-[3rem] md:leading-[5rem] font-clash font-bold mt-16">
        ...
        >
          <span className="text-main_primary">Innerve</span>
        </span>
      ...
      <div className="font-chakra text-base py-8 leading-[5px] xl:mt-4">
        ...
        >
          <b>Innerve'23</b> the annual techno - cultural fest organized by
          COLLEGE OF ENGINEERING Muttathara, is an exiting event that celebrates
          ...
          <b>Innerve'23</b> offers a diverse range of activities that cater to
      ...
      >
        <p className="text-white text-base xl:text-xl font-chakra font-medium">
          The COLLEGE OF ENGINEERING Muttathara established in 2014 is the 8th
